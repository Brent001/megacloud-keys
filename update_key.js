    ...
    fs.readFile("output.js", "utf8", async (err, data) => {
      ...
      try {
        ...
        const extra_message = `
                   ...
                   Remove all irrelevant, unused, or undefined code or any block that you don't understand — keep just the cleaned-up JavaScript that performs the key generation.
